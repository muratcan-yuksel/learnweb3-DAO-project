...
contract CryptoDevsDAO is Ownable {
    ...
    // Now, since we will be calling functions on the FakeNFTMarketplace and CryptoDevsNFT contract,
    //  let's create variables to store those contracts.
    ...
    //create a modifier which only allows a function to be called by someone who owns at least 1 nft
        ...
        activeProposalOnly(proposalIndex)
    {
        ...
        //that haven't already been used to vote on this proposal
    ...
    modifier inactiveProposalOnly(uint256 porposalIndex) {
        require(
            proposals[porposalIndex].deadline < block.timestamp,
            "DEADLINE_NOT_EXCEEDED"
        );
        require(proposals[porposalIndex].executed == false, "ALREADY_EXECUTED");
        _;
    }
        ...
        inactiveProposalOnly(proposalIndex)
    {
        ...
        //purchase the nft from the FakeNFTMarketplace contract
